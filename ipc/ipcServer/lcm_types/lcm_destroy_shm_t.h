...
#ifndef _lcm_destroy_shm_t_h
#define _lcm_destroy_shm_t_h

#ifdef __cplusplus
extern "C" {
#endif

typedef struct _lcm_destroy_shm_t lcm_destroy_shm_t;
struct _lcm_destroy_shm_t
{
    char*      shm_name;
};

/**
 * Create a deep copy of a lcm_destroy_shm_t.
 * When no longer needed, destroy it with lcm_destroy_shm_t_destroy()
 */
lcm_destroy_shm_t* lcm_destroy_shm_t_copy(const lcm_destroy_shm_t* to_copy);

/**
 * Destroy an instance of lcm_destroy_shm_t created by lcm_destroy_shm_t_copy()
 */
void lcm_destroy_shm_t_destroy(lcm_destroy_shm_t* to_destroy);

/**
 * Identifies a single subscription.  This is an opaque data type.
 */
typedef struct _lcm_destroy_shm_t_subscription_t lcm_destroy_shm_t_subscription_t;

/**
 * Prototype for a callback function invoked when a message of type
 * lcm_destroy_shm_t is received.
 */
typedef void(*lcm_destroy_shm_t_handler_t)(const lcm_recv_buf_t *rbuf,
             const char *channel, const lcm_destroy_shm_t *msg, void *userdata);

/**
 * Publish a message of type lcm_destroy_shm_t using LCM.
 *
 ...
 */
int lcm_destroy_shm_t_publish(lcm_t *lcm, const char *channel, const lcm_destroy_shm_t *msg);

/**
 * Subscribe to messages of type lcm_destroy_shm_t using LCM.
 *
 ...
 */
lcm_destroy_shm_t_subscription_t* lcm_destroy_shm_t_subscribe(lcm_t *lcm, const char *channel, lcm_destroy_shm_t_handler_t handler, void *userdata);

/**
 * Removes and destroys a subscription created by lcm_destroy_shm_t_subscribe()
 */
...
/**
 * Encode a message of type lcm_destroy_shm_t into binary form.
 *
 * @param buf The output buffer.
 * @param offset Encoding starts at this byte offset into @p buf.
 * @param maxlen Maximum number of bytes to write.  This should generally
 *               be equal to lcm_destroy_shm_t_encoded_size().
...
/**
 * Decode a message of type lcm_destroy_shm_t from binary form.
 * When decoding messages containing strings or variable-length arrays, this
 * function may allocate memory.  When finished with the decoded message,
 * release allocated resources with lcm_destroy_shm_t_decode_cleanup().
 *
 ...
 */
int lcm_destroy_shm_t_decode(const void *buf, int offset, int maxlen, lcm_destroy_shm_t *msg);

/**
 * Release resources allocated by lcm_destroy_shm_t_decode()
 * @return 0
 */
int lcm_destroy_shm_t_decode_cleanup(lcm_destroy_shm_t *p);

/**
 * Check how many bytes are required to encode a message of type lcm_destroy_shm_t
 */
